...
export class Http3PmeenanHtmlScheme extends Http3PriorityScheme {
    ...
    public constructor(logger?: QlogWrapper) {
        ...
        for (let i = 0; i < Http3PmeenanHtmlScheme.BUCKET_COUNT; ++i) {
            this.buckets.push(new Http3PMeenanBucket(i));
            this.bucketActivityMap.set(i, false);

            const self: Http3PmeenanHtmlScheme = this;
