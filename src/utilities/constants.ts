...
export class Constants {
    ...
    public static ALPN_LABELS = ["h3-20", "h3-22", "hq-20", "hq-22"]; // these are the labels that we offer as server
    public static readonly ALPN_VALID_HTTP3  = ["h3-20", "h3-22"];
    public static readonly ALPN_VALID_HTTP09 = ["hq-20", "hq-22"];
